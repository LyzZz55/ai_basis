...
class SocialVISystem:
    ...
    def __init__(self):
        ...
        你是品牌视觉设计专家，要根据输入，给出智能生成适合社交媒体的品牌色彩体系建议，输出结构严格为JSON：
        {
        "primary_colors": "...", 
        "secondary_colors": "...",
        "accent_colors": "...",
        ...
        - 设计原则知识 
        要求：
        - 结合输入，推荐主色primary_colors、辅助色secondary_colors、强调色accent_colors、基础色neutral_colors
        - 给出色彩心理学简要说明psychology_notes
        - 输出必须是完整JSON对象，字段齐全。
        """
        ...
        self.color_palette_agent = ChatAgent(
            system_message=self.color_palette_prompt,
            model=self.gemini,
        ...
        self.layout_principles = ChatAgent(
            system_message=self._get_trend_analysis_prompt(),
            model=self.trend_analysis_model,
            message_window_size=1000,
        )
    ...
    def _define_color_palette(
        ...
        try:
            ...
            try:
                ...
                print(f"<_define_color_palette>JSON解析错误： {e}")
        except Exception as e:
                print(f"<_define_color_palette>An error occured when ask for AI response: {e}")
    ...
    def _define_imagery_style_guide(
        ...
        try:
            ...
            try:
                ...
                print(f"<_define_imagery_style_guide>, JSON解析错误： {e}")
        except Exception as e:
                print(f"<_define_imagery_style_guide>An error occured when ask for AI response: {e}")
